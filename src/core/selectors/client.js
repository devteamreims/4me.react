...
export const getClientId = (state: RootState): ?ClientId => _.get(getRaw(state), 'client.id');
export const getClientType = (state: RootState): ?ClientType => _.get(getRaw(state), 'client.type');
export const getClientName = (state: RootState): ?string => _.get(getRaw(state), 'client.name', '');
